...
export const useTranslation = () => {
  ...
  const fallbacks: Record<string, string> = {
    ...
    "hero.ariaLabel": "Ir a la sección de contacto",
    ...
    "education.academicTitle": "Mi Trayectoria Académica",
    "education.badge": "Educación",
    "education.headerTitle": "Mi Trayectoria Académica",
    "education.loadMore": "Cargar Más",
    "education.totalCount": "{count} cursos completados",
    "education.latestBadge": "Nuevo",
    "education.loading": "Cargando más...",
    "education.certificate": "Certificado",
    "education.highlightsTitle": "Certificaciones destacadas",
    "education.highlightsSubtitle": "Una selección de logros que resumen mi crecimiento profesional.",
    "education.carouselPrevious": "Ver certificación anterior",
    "education.carouselNext": "Ver certificación siguiente",
    "education.goToHighlight": "Ir a la certificación {index}",
    "education.viewCertificate": "Ver certificado",
    "education.shareLinkedIn": "Compartir en LinkedIn",
    "education.sharing": "Compartiendo...",
    "education.copyInfo": "Copiar información",
    "education.copied": "¡Información copiada!",
    "education.copyError": "No se pudo copiar la información.",
    "education.close": "Cerrar",
    "education.closeModal": "Cerrar modal",
    "education.loadMoreEducation": "Cargar más educación",
    ...
    "footer.navigationTitle": "Navegación",
    "footer.followTitle": "Sígueme",
    "footer.findMe": "Base en Bogotá · Remoto en toda Colombia y USA",
    "footer.backToTop": "Inicio",
    "footer.whatsappMessage": "Hola, me interesa tus servicios.",
    "footer.whatsappAria": "Contactar por WhatsApp",
    "footer.backToTopAria": "Volver al inicio",
    "footer.mapTitle": "Ubicación de Omar Hernández Rey en Bogotá, Colombia",
    "footer.navigation.aboutMe": "Sobre Mí",
    "footer.navigation.services": "Servicios de Desarrollo Web",
    "footer.navigation.blog": "Blog Técnico",
    "footer.navigation.faq": "Preguntas Frecuentes",
    "footer.navigation.calculator": "Calculadora",
    ...
    "newsletter.success": "¡Casi listo! Revisa tu correo y confirma tu suscripción (mira también en spam).",

    ...
    items: [
      {
        ...
        description:
          "Cursé y aprobé el programa de formación profesional integral en Análisis y Desarrollo de Sistemas de Información, donde desarrollé competencias en análisis, diseño, desarrollo, implementación y mantenimiento de sistemas informáticos, cumpliendo con los requisitos establecidos por el SENA.",
    ...
    items: [
      {
        ...
        description:
          "Participé en el bootcamp de nivel avanzado en Desarrollo Web Full Stack, enfocado en adquirir competencias prácticas en tecnologías modernas para el desarrollo de aplicaciones web completas. Este programa se realizó en modalidad virtual.",
    ...
    items: [
      {
        ...
        description:
          "Obtuve la certificación como especialista certificado en desarrollo web Full Stack, demostrando habilidades avanzadas en el desarrollo y gestión de aplicaciones web completas.",
      ...
      },
      {
        ...
        duration: "Finalizado el 31 de octubre de 2024",
        description:
          "Obtuve la certificación como profesional certificado en desarrollo Back End, demostrando habilidades avanzadas en la creación, gestión y optimización de servidores, bases de datos y lógica de aplicaciones.",
        logo: "/images/education/ITCertificate/itcertificate-logo.png",
        certificate:
  ...
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Cursé y aprobé la formación en Metodología de la Programación de Sistemas Informáticos, adquiriendo conocimientos fundamentales en el diseño, desarrollo y análisis de sistemas informáticos.",
        logo: "/images/education/sena/sena-logo.png",
        certificate:
      ...
      },
      {
        ...
        description:
          "Cursé y aprobé la formación en Construcción de Bases de Datos con MySQL, desarrollando habilidades para diseñar, implementar y gestionar bases de datos relacionales utilizando MySQL.",
        logo: "/images/education/sena/sena-logo.png",
        certificate:
      ...
      {
        title:
          "Atender Clientes de Acuerdo con Procedimiento de Servicio y Normativa - Nivel Intermedio",
        institution: "Servicio Nacional de Aprendizaje (SENA)",
        duration:
          "Certificación de Competencia Laboral (Emitido el 22 de octubre de 2020, vigente hasta el 22 de octubre de 2023)",
        description:
          "Certificado de competencia laboral que acredita habilidades intermedias para atender clientes conforme a procedimientos de servicio y normativas vigentes, demostrando competencias en atención al cliente y gestión administrativa.",
        logo: "/images/education/sena/sena-logo.png",
        certificate:
      ...
      },
      {
        ...
        description:
          "Cursé y aprobé la formación en Mentalidad de Líder, adquiriendo competencias en liderazgo, gestión de equipos y habilidades estratégicas para impulsar el desarrollo personal y profesional.",
        logo: "/images/education/sena/sena-logo.png",
        certificate:
      ...
      // 1
      {
        ...
        description:
          "Curso práctico para dominar el consumo de APIs REST con JavaScript, aplicando técnicas avanzadas para integrar servicios y datos en aplicaciones web.",
      ...
      // 2
      {
        ...
        description:
          "Curso orientado a aprender cómo consumir APIs REST utilizando JavaScript para crear aplicaciones dinámicas e integradas.",
        logo: "/images/education/platzi/platzi-logo.png",
        certificate:
      ...
      // 3
      {
        ...
        description:
          "Curso enfocado en aprender a interactuar y modificar el Document Object Model (DOM) utilizando JavaScript para crear interfaces dinámicas y responsivas.",
        logo: "/images/education/platzi/platzi-logo.png",
        certificate:
      ...
      // 7
      {
        ...
        description:
          "Participé y aprobé el curso de Base de Datos con SQL, adquiriendo habilidades en el diseño, consulta y manejo eficiente de bases de datos relacionales utilizando SQL.",
        logo: "/images/education/platzi/platzi-logo.png",
        certificate:
      ...
      // 8
      {
        ...
        description:
          "Participé y aprobé el curso Fundamentos de JavaScript, obteniendo una base sólida en el lenguaje y las mejores prácticas para el desarrollo web.",
        logo: "/images/education/platzi/platzi-logo.png",
        certificate:
      ...
      // 21
      {
        ...
        description:
          "Participé y aprobé el curso React.js con Vite.js y TailwindCSS, aprendiendo a desarrollar aplicaciones web modernas y altamente eficientes utilizando estas tecnologías.",
        logo: "/images/education/platzi/platzi-logo.png",
        certificate:
      ...
      // 22
      {
        ...
        description:
          "Curso diseñado para aprender los fundamentos de React.js, creando aplicaciones web interactivas y escalables mediante componentes y manejo de estados.",
        logo: "/images/education/platzi/platzi-logo.png",
    ...
    "certificate": "/images/education/platzi/01DiplomaDelCursoDeConfiguracinDeEntornoDeDesarrolloEnWindows.png"
      ...
      // 46
      {
        ...
        duration: "12 horas (Aprobado el 9 de julio de 2023)",
        description:
          "Participé y aprobé el curso de Configuración de Entorno de Desarrollo en Windows, adquiriendo conocimientos prácticos para configurar herramientas y entornos eficientes para el desarrollo de software en sistemas operativos Windows.",
        logo: "/images/education/platzi/platzi-logo.png",
        certificate:

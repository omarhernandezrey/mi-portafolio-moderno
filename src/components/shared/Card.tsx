// components/shared/Card.tsx - Updated with LinkedIn Share
...
interface CardProps {
  ...
  repository: string;
  demo: string;
  category?: string; // Agregamos category para LinkedIn
}
...
const Card: React.FC<CardProps> = ({
  ...
  repository,
  demo,
  category = "Web Development", // Valor por defecto
}) => {
  // Datos del proyecto para LinkedIn
  const projectData = {
    title,
    description,
    technologies,
    ...
    >
      ...
      <div className="mt-6 text-center">
        ...
        <div className="flex flex-col gap-4 mt-6">
          ...
          {/* Botón de LinkedIn - Fila separada */}

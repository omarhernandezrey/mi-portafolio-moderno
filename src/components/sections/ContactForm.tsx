...
// Bandas de presupuesto por mercado — ver src/data/pricing-sources.ts.
// El valor lleva el prefijo de moneda ("cop:"/"usd:") para que el lead
// nunca quede ambiguo sobre a qué escala pertenece el número.
const BUDGET_TIERS = [
  { cop: "cop:<1800000", usd: "usd:<1200" },
  { cop: "cop:1800000-6000000", usd: "usd:1200-8000" },
  { cop: "cop:6000000-18000000", usd: "usd:8000-25000" },
  { cop: "cop:18000000+", usd: "usd:25000+" },
] as const;
...
export default function ContactForm() {
  ...
  const currency = isEn ? 'usd' : 'cop';
  const notyf = useNotyf();

  const serviceOptions = [
    { value: "", label: t('contact.form.servicePlaceholder') },
    { value: "landing-page", label: t('contact.form.serviceOptions.landingPage') },
    { value: "sitio-web", label: t('contact.form.serviceOptions.fullWebsite') },
    { value: "e-commerce", label: t('contact.form.serviceOptions.ecommerce') },
    { value: "app-web", label: t('contact.form.serviceOptions.webApp') },
    { value: "seo", label: t('contact.form.serviceOptions.seo') },
    { value: "automatizacion", label: t('contact.form.serviceOptions.automation') },
    { value: "otro", label: t('contact.form.serviceOptions.other') },
  ];

  const budgetOptions = [
    { value: "", label: t('contact.form.budgetPlaceholder') },
    { value: BUDGET_TIERS[0][currency], label: t('contact.form.budgetOptions.tier1') },
    { value: BUDGET_TIERS[1][currency], label: t('contact.form.budgetOptions.tier2') },
    { value: BUDGET_TIERS[2][currency], label: t('contact.form.budgetOptions.tier3') },
    { value: BUDGET_TIERS[3][currency], label: t('contact.form.budgetOptions.tier4') },
  ];

  const timelineOptions = [
    { value: "", label: t('contact.form.timelinePlaceholder') },
    { value: "urgent", label: t('contact.form.timelineOptions.urgent') },
    { value: "month", label: t('contact.form.timelineOptions.month') },
    { value: "2-3months", label: t('contact.form.timelineOptions.quarter') },
  ...
  const sendEmail = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      notyf.success(t('contact.form.success'));
      ...
      const msg = error instanceof Error ? error.message : t('contact.form.error');
      notyf.error(msg);
    } finally {
      setIsSending(false);
    }
          ...
          >
            ...
            >
              ...
              <motion.div className="md:col-span-2 flex flex-col sm:flex-row items-center justify-center gap-4 mt-6">
                ...
                <a
                  href={buildWhatsAppUrl(t('contact.form.whatsappMessage'))}
                  target="_blank"
